...
|    |      Feature      | Summary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:---|:-----------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ⚙️ | **Architecture**  | <ul><li>Uses a stage-based execution model, where individual processing steps (`StageExecutor` interface,  [src/main/java/com/github/nishgpt/chainexecutor/models/execution/StageExecutor.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/models/execution/StageExecutor.java)) are chained together (`StageChain` class, [src/main/java/com/github/nishgpt/chainexecutor/models/stage/StageChain.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/models/stage/StageChain.java)).</li><li>`StageExecutionManager` orchestrates the execution of these stages, managing their lifecycle and ensuring sequential execution ([src/main/java/com/github/nishgpt/chainexecutor/StageExecutionManager.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/StageExecutionManager.java)).</li><li>Employs a factory pattern (`StageExecutorFactory`, [src/main/java/com/github/nishgpt/chainexecutor/models/execution/StageExecutorFactory.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/models/execution/StageExecutorFactory.java)) for creating and managing `StageExecutor` instances, promoting flexibility and extensibility.</li><li>Utilizes custom exceptions (`ChainExecutorException`, [src/main/java/com/github/nishgpt/chainexecutor/exceptions/ChainExecutorException.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/exceptions/ChainExecutorException.java)) and error codes (`ErrorCode`, [src/main/java/com/github/nishgpt/chainexecutor/exceptions/ErrorCode.java](chain-executor-core/src/main/java/com/github/nishgpt/chainexecutor/core/exceptions/ErrorCode.java)) for robust error handling.</li></ul> |
